...
#define FP_INTERV 2 /// THIS HAS TO BE EQUAL OR LESS TO THE ELEMENTS CAPACITY OF SST AND (FP_INTERV + 1) MUST BE AN EXACT DIVIDER OF THAT VALUE (SO MOD SHOULD BE ZERO)
