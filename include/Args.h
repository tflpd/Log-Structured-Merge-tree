...
#define FP_INTERV 2 /// DETERMINES HOW MANY KEYS WILL EXIST BETWEEN TWO FENCE POINTERS. E.G. IF WE HAVE THE 1 4 5 6 KEYS IN A RUN AND AN INTERVAL = 1 THEN THE FPS WILL BE 1, 5, 6
